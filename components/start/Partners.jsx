...
export default function Partners() {
  return (
    <section className="py-[72px] px-32 flex flex-col gap-32">
      <div className="flex items-center gap-3 justify-center">
        ...
        <h1 className="text-white text-5xl text-opacity-80 leading-normal tracking-[2.4px]">
          Joining forces for a better
