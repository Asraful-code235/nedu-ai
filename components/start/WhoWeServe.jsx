...
export default function WhoWeServe() {
  return (
    <section className=" px-4 pt-8 pb-10 lg:px-16 lg:py-18 2xl:px-32  ">
      <motion.div className="lg:px-[70px] flex flex-col items-start lg:items-center justify-center text-center gap-3 lg:gap-[25px]">
        <h1 className="visionParagraph text-start lg:text-center text-xl lg:text-5xl xl:text-6xl font-normal leading-[0px] text-white text-opacity-80">
          Who we{" "}
          <span className="text-darkYellow font-extrabold relative">
            ...
            <svg
              ...
              viewBox="0 0 21 22"
              fill="none"
              className="absolute w-5 h-5 lg:w-[48px] lg:h-[38px] -top-2 -right-2 lg:-top-[14px] xl:-top-[11px] lg:-right-[19px] xl:-right-[18px]"
            >
              <path
        ...
        <p className="visionParagraph text-white max-w-[1180px] mx-auto text-start lg:text-center text-opacity-80 text-sm lg:text-xl xl:text-2xl font-medium lg:leading-[32px] lg:tracking-[0px] xl:tracking-[1.3px]">
      ...
      <motion.div className=" mt-[64px] md:mt-[128px] lg:mt-[196px] flex flex-col-reverse xl:flex-row items-center justify-start gap-16 sm:gap-24 lg:gap-24">
        <article className="visionParagraph max-w-[733px] mx-auto xl:flex-[0.75] xl:max-w-[770px] flex flex-col items-start justify-center gap-1 md:gap-5">
          ...
          <h2 className="visionParagraph text-white w-full text-start text-[17px] lg:text-center xl:text-start font-bold lg:font-bold leading-[23.8px] lg:leading-[44px] tracking-[-1.32px]  lg:text-[40px] mt-1">
            Experience a smarter way to recruit with NeduAI
          </h2>
          <p className="visionParagraph text-xs lg:text-xl xl:max-w-full w-full text-start lg:text-center xl:text-start text-white font-medium lg:font-medium leading-[17.4px] tracking-[0] lg:leading-[32px] mt-2 lg:-mt-2">
