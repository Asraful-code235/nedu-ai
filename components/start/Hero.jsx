...
export default function Hero() {
  return (
    <section className="p-6  md:px-12 xl:px-32 xl:py-16 h-[80vh] flex items-end xl:items-center justify-center xl:justify-start text-start xl:text-center">
      <div className="text-xl lg:text-2xl xl:text-5xl flex flex-col items-center justify-center xl:items-start xl:justify-start gap-3 lg:gap-4 font-semibold leading-[30px] lg:leading-[57px] tracking-[1.2px] lg:tracking-[2.4px]">
