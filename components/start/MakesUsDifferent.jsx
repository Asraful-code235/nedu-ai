    ...
    <section className="dottedBackground p-6 md:p-12 xl:px-32 xl:py-16">
      <section className="relative rounded-[60px] bg-[#FFE000] py-9 lg:py-28">
        <div className="flex flex-col items-start lg:items-center justify-start lg:justify-center gap-2 lg:gap-8">
          ...
          <p className="visionParagraph text-start lg:text-center px-6 lg:px-16 text-xs lg:text-xl xl:text-2xl font-medium text-black text-opacity-90 leading-[20px] lg:leading-[40px] tracking-[0.4px] xl:tracking-[0.48px] ">
        ...
        <div className="xl:px-60 xl:py-60 lg:p-[96px] p-6 border border-transparent rounded-lg">
              ...
              <div className=" DashboardBefore2 relative">
                <div className="w-[60vw] DashboardBefore3 relative">
                  ...
                  <Image
                    ...
                    width={600}
                    height={600}
                    className="w-full absolute -bottom-[40%] -left-[24%] scale-[0.6] object-cover object-center rounded-xl cursor-pointer"
                    alt="Dashboard"
                  />
                  <Image
