  ...
  return (
    <div className="youthEmpowerment relative md:py-14 overflow-hidden">
      <section className="md:py-24 w-full relative [background:url('/icons/youthEmpowermentDesktop.svg')] bg-no-repeat bg-center bg-cover">
        ...
        <div className=" py-40 flex flex-col-reverse xl:flex-row items-center justify-center place-items-center w-screen">
          <section className="p-4 xl:pl-32 w-full flex-[0.75] flex flex-col items-start md:gap-5 z-20">
            ...
            <div className="w-full mt-4 md:mt-0 flex flex-col gap-3 items-start md:items-center xl:items-start justify-center xl:justify-start">
              <Button
                variant="light"
                className="bg-white w-fit text-[#0081B5] px-[16px] py-[5px] md:px-16 md:py-5 rounded-md md:rounded-xl text-xs md:text-2xl tracking-[0.058px] leading-[140.18%] font-semibold border-none"
              >
              ...
              <div className="hidden md:flex items-center gap-2 ">
                ...
                />
                <p className="visionParagraph text-white font-medium leading-9 text-xl">
                  Only restricted to registered users
                </p>
              </div>
            </div>
          </section>
