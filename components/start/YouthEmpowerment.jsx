    ...
    <div className="youthEmpowerment relative  md:py-14 overflow-hidden">
      <section className=" md:py-24 w-full relative bg-[#0979a7] bg-no-repeat bg-center bg-cover">
        ...
        <div className="py-24 md:py-40 flex flex-col-reverse xl:flex-row items-center justify-center place-items-center w-screen">
          <section className="px-4 xl:pl-32 w-full flex-[1] flex flex-col items-start md:gap-5 z-20">
            <Image
            ...
            <p className="visionParagraph mx-auto max-w-[697px] flex flex-col gap-4 text-start md:text-center xl:text-start xl:max-w-full text-white font-normal md:font-medium text-xs md:text-xl leading-5 md:leading-9">
              ...
              peers for engaging activities, and offers professional support for
              those facing significant challenges.
              <br />
              <br />
              At our upcoming event, we&apos;ll showcase the Happy Halpline AI,
              a proactive and friendly AI-powered app aiding youth to navigate
              their challenges, promoting self-understanding and wellbeing.
              <br />
              <br />
              Together, we&aposlre dedicated to ensuring Marbella&apos;s youth
